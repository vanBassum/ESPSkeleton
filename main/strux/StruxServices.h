...
// finds a peer.
//
// Note what is NOT here: the Board. The framework does not touch hardware, and that is
...
// acyclic. A StruxManager that wanted AppServices& would be a design error, not a
// missing accessor.
